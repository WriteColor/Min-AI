...
class WindowsService:
    ...
    def restore_window(self, hwnd: int, verify: bool = True, log_action: bool = False) -> bool:
        ...
        if log_action:
            try:
                ...
                action_id = get_logger().start_action(
                    ...
                    target_window=win_info.title if win_info else str(hwnd),
                    capture_before=True
                )
                get_logger().capture_before_shot(action_id)
            except Exception:
                action_id = None
        ...
        try:
            ...
            if verify:
                ...
                verified = is_now_restored and is_foreground
                if not verified:
                    success = False
    ...
    def minimize_window(self, hwnd: int, verify: bool = True, log_action: bool = False) -> bool:
    ...
    def maximize_window(self, hwnd: int, verify: bool = True, log_action: bool = False) -> bool:
    ...
    def close_window(self, hwnd: int, verify: bool = True, log_action: bool = False) -> bool:
